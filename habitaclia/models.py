...
class Property(Base):
    ...
    #     'Details',
    #     secondary='scrapedata.property_details',
    #     backref='holdings',
    #     lazy='dynamic'
    # )
    #
    ...
    #     'Multimedia',
    #     secondary='scrapedata.property_multimedia',
    #     backref='workplace',
    #     lazy='dynamic'
    # )
    #
    # agents = relationship(
    #     'Agents',
    #     secondary='scrapedata.property_agents',
    #     backref='firm',
    #     lazy='dynamic'
    # )
    #
    ...
    #     'Additional',
    #     secondary='scrapedata.property_additional',
    #     backref='firm',
    #     lazy='dynamic'
    # )
